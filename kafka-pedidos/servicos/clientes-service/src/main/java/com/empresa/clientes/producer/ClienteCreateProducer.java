...
public class ClienteCreateProducer {
    ...
    public void publicar(ClienteCreateEvent event) {
        try {
            String topic = kafkaProperties.topics().clientCreate();
            ...
            log.info("Evento client-create publicado: eventId={}, topico={}, particao={}",
