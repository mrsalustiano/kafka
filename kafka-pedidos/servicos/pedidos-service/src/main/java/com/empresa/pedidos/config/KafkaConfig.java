...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, PedidoResponseEvent> consumerFactory() {
        Map<String, Object> configs = new HashMap<>();
        ...
        configs.put(JsonDeserializer.VALUE_DEFAULT_TYPE, PedidoResponseEvent.class.getName());
        return new DefaultKafkaConsumerFactory<>(configs);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PedidoResponseEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, PedidoResponseEvent> consumerFactory,
            KafkaTemplate<String, Object> kafkaTemplate) {
        ConcurrentKafkaListenerContainerFactory<String, PedidoResponseEvent> factory =
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<String, Object> kafkaTemplate) {
        DeadLetterPublishingRecoverer recoverer = new DeadLetterPublishingRecoverer(
                ...
                (record, ex) -> new TopicPartition(
                        kafkaProperties.topics().pedidoResponseDlt(),
                        record.partition()
                )
        );
