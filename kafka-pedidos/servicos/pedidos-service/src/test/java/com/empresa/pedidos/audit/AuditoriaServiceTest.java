...
class AuditoriaServiceTest {
    ...
    void registrar_devePersistirAuditoria() {
        ...
        verify(auditoriaRepository).registrar(eq("CREATE"), eq("PEDIDO"), eq(1L), eq("corr-1"), eq("detalhe"));
    }
    ...
    void registrarErro_deveUsarOperacaoErro() {
        ...
        verify(auditoriaRepository).registrar(eq("ERRO"), eq("PEDIDO"), eq(1L), eq(null), eq("falha"));
    }
}
