...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, ClienteCreateEvent> consumerFactory() {
        Map<String, Object> configs = new HashMap<>();
        ...
        configs.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ClienteCreateEvent.class.getName());
        return new DefaultKafkaConsumerFactory<>(configs);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ClienteCreateEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, ClienteCreateEvent> consumerFactory,
            KafkaTemplate<String, Object> kafkaTemplate) {
        ConcurrentKafkaListenerContainerFactory<String, ClienteCreateEvent> factory =
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<String, Object> kafkaTemplate) {
        DeadLetterPublishingRecoverer recoverer = new DeadLetterPublishingRecoverer(
                ...
                (record, ex) -> new TopicPartition(
                        kafkaProperties.topics().clientCreateDlt(),
                        record.partition()
                )
        );
