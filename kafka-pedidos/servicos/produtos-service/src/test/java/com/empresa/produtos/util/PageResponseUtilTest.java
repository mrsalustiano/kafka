...
class PageResponseUtilTest {
    ...
    void resolveSortColumn_padrao() {
        assertThat(PageResponseUtil.resolveSortColumn(null)).isEqualTo("codigo_produto");
    }

    @Test
    void resolveSortColumn_valido() {
        assertThat(PageResponseUtil.resolveSortColumn("descricao,asc")).isEqualTo("descricao");
    }
    ...
    void resolveSortDirection_desc() {
        assertThat(PageResponseUtil.resolveSortDirection("valor,desc")).isEqualTo("DESC");
    }
    ...
    void resolveSortDirection_invalido_deveLancarExcecao() {
        assertThatThrownBy(() -> PageResponseUtil.resolveSortDirection("valor,invalid"))
                .isInstanceOf(ValidationException.class);
    }
    ...
    void resolveSortColumn_quandoBlank_deveRetornarPadrao() {
        assertThat(PageResponseUtil.resolveSortColumn("   ")).isEqualTo("codigo_produto");
    }

    @Test
    void resolveSortDirection_quandoSortSemVirgula_deveRetornarAsc() {
        assertThat(PageResponseUtil.resolveSortDirection("descricao")).isEqualTo("ASC");
    }
}
